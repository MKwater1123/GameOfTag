...
`js/app.js` の `GAME_SETTINGS` を編集:

```javascript
const GAME_SETTINGS = {
    center_lat: 35.6895,      // エリア中心の緯度
    center_lng: 139.6917,     // エリア中心の経度
...
```javascript
const RUNNER_UPDATE_INTERVAL = 10 * 60 * 1000; // 10分（ミリ秒）
```
